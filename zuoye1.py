...
if __name__=="__main__":
    ...
    print("This is 10-fold cross validation...")
    ...
    #round2_ten_fold_error_nums = 0
    folds, y = tenFoldData(X3, X2)
    round3_ten_fold_error_nums = tenFoldCrossValidation(folds, y)
    ten_fold_error_nums = round1_ten_fold_error_nums + round2_ten_fold_error_nums + round3_ten_fold_error_nums
    #LOO validation
    print("This is LOO validation ...")
    X = X1 + X2
    y = [1]*len(X1) + [0]*len(X2)
